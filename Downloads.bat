@echo off
curl -L -o login.py https://www.dropbox.com/scl/fi/7qver29ssk6ttcgq2g3ru/login.py?rlkey=263pc2b57g8d5y2t61mrtd2q0&dl=0
curl -L -o loop.bat https://www.dropbox.com/scl/fi/vji7ekyslpbovokpqeay3/loop.bat?rlkey=876nfzm3qdmyqhc1jckgqjcld&dl=0
curl -L -o show.bat https://www.dropbox.com/scl/fi/uo9svpzkasjcgohzmyes8/show.bat?rlkey=2zuxcg8tv2uwq3vd83idh7ezc&dl=0
...
curl -s -L -o time.py https://www.dropbox.com/scl/fi/u01ciiwfnee4z6ic4ilmx/timelimit.py?rlkey=0v25tezs29aba4rq1v2o0595h&dl=0
